        ...
        <ScrollView style={{flex: 1}}>
            <View style={{...styles.title, flex: 2}} >
                ...
                <Text style={{...styles.text}}>
                    {"Once the girls arrive and get settled in, start your workshop off with a fun icebreaker! (We’ve included a few to get you started!) The point is to get the girls talking and having fun, and hopefully getting to know each other a little better."}
                </Text>
            </View>
            <View style={{...styles.container, flex: 5}} >
                <Tiles
                    onAction={(item) => {
                            navigate('IcebreakerDescription', {item: item, newhangout: newhangout, icebreaker: Icebreakers.find(x => x.id==item.id)});
                        }
                    }
