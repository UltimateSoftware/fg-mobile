...
export class EditableProfileFrame extends Component{

    constructor(props)
    {
        super(props)
        this.state = {avatarSize: props.avatarSize, editable: props.editable, source: props.source}
    }
    ...
    render() {
        const size = this.styleValuesFromSize(this.state.avatarSize).size;
